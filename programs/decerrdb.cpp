...
//
//  Implementation of class TDecErrDeBerg, sub-class of TDecErrDelaunay, for
...
void TDecErrDeBerg::NextVertex()
{
    ...
    #ifdef DEBUG
       DEBUG << "\nTDecErrDeBerg::NextVertex()" << endl;
    #endif

    #ifdef ROBUST
       check( (DeBergVertices.IsEmpty() && ElimVtxTree.IsEmpty()), 
              "TDecErrDeBerg::NextVertex(), <1> no more points to remove" );
    #endif
